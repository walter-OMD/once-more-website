...
RESOURCES = [
    {
        ...
        "desc": "A plain-language guide to SEO for businesses in Malaysia: how search works here, what actually moves rankings, and how SEO, GEO and content fit together.",
        "eyebrow": "Guide",
        "h1": "SEO for Malaysian businesses, explained simply",
    ...
    },
    {
        ...
        "body": [
            ...
            ("How to judge whether it is worth it",
             "<p>Compare the investment to the value of a customer. If a single new client is worth a meaningful sum to you, even modest ranking gains can pay for the work many times over. Look for providers who ask about your goals before your budget, and who report in plain language so you can see what is happening.</p>"),
