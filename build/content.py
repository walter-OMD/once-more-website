...
RESOURCES = [
    ...
    },
    {
        ...
        "desc": "An honest look at SEO pricing in Malaysia: what drives the cost, why fixed packages can mislead, and how to judge whether an investment is worth it.",
        "eyebrow": "Guide",
        "h1": "How much does SEO cost in Malaysia?",
        "intro": "There is no single price for SEO, and anyone quoting one before understanding your business is guessing. Here is what actually drives the cost and how to judge value.",
        "answer": "There is no single price for SEO in Malaysia, because the work needed depends on your market, your starting point and how competitive your terms are. Be cautious of fixed packages quoted before anyone has looked at your site; good SEO is scoped to the work that will actually move results.",
        "tldr": [
            "SEO has no flat rate; cost depends on your situation.",
            "Fixed packages often bundle the wrong work.",
            "You pay for research, technical fixes, content and authority.",
            "Judge value against what one new customer is worth to you.",
            "Choose providers who ask about goals before budget.",
        ],
        "body": [
            ("Why there is no flat rate",
             "<p>The work needed to move rankings varies enormously. A new site in a competitive market needs far more than an established site that simply needs tidying. So the honest answer is that cost depends on your starting point, your market and how ambitious the goals are. Fixed packages can look reassuring, but they often bundle work you do not need and skip work you do.</p>"),
        ...
        "faqs": [
            ...
            ("Should I pay monthly or per project?",
             "Both can work. Ongoing markets suit a monthly arrangement; a defined fix or build can be a project. What matters is that the scope matches the goal."),
        ],
    },
]
